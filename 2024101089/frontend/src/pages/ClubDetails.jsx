        ...
        <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            ...
            {events.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {events.map(event => (
                        <div key={event._id} className="bg-white rounded-lg shadow hover:shadow-md transition-shadow overflow-hidden flex flex-col h-full border border-gray-100">
                            <div className="p-6 flex-grow">
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    {event.registrationLimit > 0 && (
                                        <span className="text-xs text-gray-500 font-mono">Limit: {event.registrationLimit}</span>
                                    )}
                                </div>
